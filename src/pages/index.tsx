  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Streamlining the dining experience. Reserve tables effortlessly and manage reservations with ease. Reinventing restaurant management, one table at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Streamlining the dining experience. Reserve tables effortlessly and manage reservations with ease. Reinventing restaurant management, one table at a time.`}
            </Text>
            <Box
